          ...
          <div className="col-start-10 h-[5rem] col-end-12 font-medium flex justify-end items-center">
            <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500 px-4 items-center">
              <NavLink
                to="/"
                className={
                  "m-0 p-2 cursor-pointer animation-hover h-[5rem] px-3.5 relative items-center justify-center flex text-black-500 hover:bg-[#5c7e59] hover:text-white text-sm a"
                }
              >
              ...
              <NavLink
                to="listing"
                className={
                  "m-0 p-2 cursor-pointer animation-hover h-[5rem] px-3 relative items-center justify-center flex text-black-500 hover:bg-[#5c7e59] hover:text-white text-sm a"
                }
              >
                <span className="text-center font-light relative">
              ...
              <div
                ...
                className={
                  "m-0 p-2 cursor-pointer animation-hover h-[5rem] text-decor px-3 relative items-center justify-center flex text-black-500 hover:bg-[#5c7e59] hover:text-white text-sm a"
                }
              >
                <span className="text-center font-light relative">
