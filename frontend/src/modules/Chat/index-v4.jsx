...
const Chat = () => {
  ...
  return (
    <div className="w-full h-full bg-[#F8F8F8]" id="profile">
      <div className="flex border h-[100dvh] pt-[4.5rem] border-grey rounded shadow-lg">
        {mobile ? (
          <>
              ...
              <div className="relative mx-auto rounded-lg">
                <div className="pb-3">
                  {!openConvo ? (
                    ...
                    <>
                      <div className="flex items-center mb-5 py-3 shadow-md">
                        <TbArrowLeft
                          className="flex text-md font-semibold uppercase text-gray-800 pl-2 w-9 h-9"
